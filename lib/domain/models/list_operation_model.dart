...
class ListOperationModel {
  ...
  factory ListOperationModel.fromRawJson(String str) => ListOperationModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ListOperationModel.fromJson(Map<String, dynamic> json) => ListOperationModel(
